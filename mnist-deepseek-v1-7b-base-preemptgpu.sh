...
#SBATCH --job-name DS7BMGPU # Job name 8 characters or less Deepseek 7B on MNIST
...
# need to run image-predict-deepseek-v1-7b-base.py --debug --cifar10 
python mnist-deepseek-v1-7b-base.py
#===============================================================================
